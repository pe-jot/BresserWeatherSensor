...
#define PRELOAD_750US			0xA3	/* = 93 ticks */
#define PRELOAD_500US			0xE1	/* = 31 ticks */
#define PRELOAD_250US			0xC2	/* = 62 ticks */
...
ISR(TIMER0_OVF_vect)
{
	...
	else
	{
		 ...
		 */
		OCR0A = (temp & 0x80) ? PRELOAD_500US : PRELOAD_250US;
		temp = temp << 1;					
	}
